# -*- coding: utf-8 -*-
"""
Created on Wed Sep  2 10:05:31 2020

@author: yyimi

Paser Question (ie transfer to SQL sentence)
"""
...
class QuestionPaser:
    ...
    def sql_transfer(self, question_type, entities):
        ...
        # 查询疾病的持续时间
            ...
            sql = ["MATCH (m:Disease) where m.name = '{0}' return m.name, m.period".format(i) for i in entities]
